        ...
        <div class="large-12 columns">
            ...
            <ul class="large-block-grid-2 small-block-grid-1" data-equalizer data-equalizer-mq="large-up">
                ...
                <li>
                        ...
                        <hr>
                        <ul class="circle">
                            <li>Attendance – decrease in number of persistent absences. There were no fixed term or permanent exclusions</li>
                            <li>Provisional exam data indicates (i) PP attainment increased by 5% (ii) the gap between PP and non PP attainment increased by 5%</li>
                        </ul>
                </li>
                <li>
                        <h5>Funding</h5>
                        <hr>
                        <ul class="circle">
                            <li>Received £468,300 Pupil Premium &amp; Summer School funding</li>
                            <li>Spent £503,454 on providing additional support for students who qualify for Pupil Premium</li>
                        </ul>
                </li>
                <li>
...
<section class="grey-bg">
    ...
    <div class="row">
        <div class="medium-push-4 medium-8 columns">
            <h4>Pupil Premium impact 2013-2014</h4>
            <p><strong>Achievement</strong> – In August 2014 provisional exam data indicated a gap between PP and non-PP attainment of 9% for 5AC EM.  PP attainment increased by 5% in 2014 from 2013.</p>
            <p>The Pupil Survey 2013-2014 for Year 11 reveals 96% of students believed they had been taught well during their time at Park Community School, with 81% finding study clubs helpful.</p>
            <p>Of the students offered additional English/Maths tuition, 92% found it to be helpful.</p>

            <p><strong>Attendance</strong> – students being able to access appropriate programmes and receive relevant support has meant that there were only 5 persistent absentees in Year 11 students on Free School Meals.</p>

            <p><strong>Residential, Social and Cultural visits</strong> – the school has continued to support funding for a number of international, residential and cultural visits for identified students, in addition to school subsidy and the governors’ subsidy on many more local school trips.</p>
            <p>As a result of the English residential in March 2014, 81% of Pupil Premium students stated they felt more confident about their writing exam.  In addition, 100% of Pupil Premium students believed they had learnt one new strategy they could apply to their writing when they returned to school.</p>
        </div>
        <div class="small-offset-2 small-pull-2 small-8 small-8 medium-pull-8 medium-offset-0 medium-4 columns"><img src="images/general/general-16.jpg" alt="Park Community School - Students enjoy the freedom to read real books"></div>
    </div>
    <br><br>
</section>
    ...
    <div class="row">
        <div class="columns">
            ...
            <ul class="circle">
                ...
                <li>Residential for targeted students with the focus on English GCSE.</li>
            </ul>
            <br>
            <h5>2014 - 2015</h5>
            <ul class="circle">
...
<section class="grey-bg">
    ...
    <div class="row">
        <div class="medium-push-4 medium-8 columns">
            ...
            <h5>2014 - 2015 we have received</h5>
            ...
            <ul class="circle">£40,500 Summer School Funding
                <li>126 year 6-7 students benefitted from our Summer School in August 2014.  Of these students, 71 were in receipt of Pupil premium funding and of these 43 attended every day.</li>
            </ul>
        </div>
        <div class="small-offset-2 small-pull-2 small-8 small-8 medium-pull-8 medium-offset-0 medium-4 columns"><img src="images/general/general-03.jpg" alt="Park Community School - Supportive Teachers boost student's learning"></div>
    </div>
    <br><br>
</section>
