    ...
    <div class="row">
        ...
        <br>
            ...
            <ul class="circle">
                ...
                <li>Geometry and measures: learn and apply formulae in order to calculate problems.</li>
                <li>Probability</li>
                <li>Statistics</li>
            </ul>
            ...
            <ul class="accordion" data-accordion role="tablist">
                ...
                <li class="accordion-navigation">
                    <a href="#panel1d" role="tab" id="panel1d-heading" aria-controls="panel1d">Keystage 3 - National Curriculum - Collins Mathematics</a>
                    <div id="panel1d" class="content" role="tabpanel" aria-labelledby="panel1d-heading">
                        ...
                        <small>For more information please visit the <a href="http://www.collins.co.uk/category/Secondary/Maths#KS3" target="_blank">Collins Education website</a></small>
                    </div>
                </li>
                ...
                <li class="accordion-navigation">
                    ...
                    <div id="panel2d" class="content" role="tabpanel" aria-labelledby="panel2d-heading">
                        ...
                        <p class="text-capitalize">Main skills students develop:</p>
                        <ul class="circle">
                            <li>We teach the Edexcel linear course with pupils either following the foundation or higher specification. </li>
                            <li>The foundation course covers a range of topics in Number, Algebra, Shape and Data handling up to C grade. It emphasises pupils ability to use these skills and also be able to apply them to real life problems. </li>
                            <li>The higher course takes these topics further so pupils can tackle more complex problems, as well as giving them the basis they need to use Mathematics beyond GCSE.</li>
                        </ul>
                        
                        <small>For more information please visit the <a href="http://qualifications.pearson.com/en/qualifications/edexcel-gcses/mathematics-a-2010.html" target="_blank">Pearson website</a></small>
