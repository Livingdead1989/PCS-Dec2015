...
<!-- MODALS -->
<!-- LaserTag -->
<div id="pty-LaserTag" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
    ...
    <ul class="circle">
        <li>Minimum age of 7 years</li>
        <li>Maximum attending of 16 children</li>
    </ul>
    <hr>
...
<!-- BouncyCastle -->
<div id="pty-BouncyCastle" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
...
<!-- SoftPlay -->
<div id="pty-SoftPlay" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
    <h2 class="text-center" id="modalTitle">Bouncy Castle &amp; Soft Play Party Package</h2>
...
<div id="pty-AssaultCourse" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
    ...
    <p class="lead">Includes</p>
    <ul class="circle">
        <li>Assault course 20 metres long</li>
        <li>1 Bouncy castle 6.8m x 5.7m x3.95m</li>
        <li>We supply a variety of background music</li>
        <li>Two tables that sit 24 children and covered with party table coverings</li>
        <li>Hot water pots and water jugs available on request</li>
...
<!-- TreasureHunt -->
<div id="pty-TreasureHunt" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
