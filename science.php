    ...
    <div class="row">
        ...
        <br>
            ...
            <ul class="small-block-grid-1 medium-block-grid-2">
                ...
                <li>Pure and impure substances</li>
                <li>Chemical reactions</li>
                <li>Energetics</li>
                <li>The Periodic Table</li>
                <li>Materials</li>
                <li>Earth and atmosphere</li>
            </ul>
            ...
            <ul class="accordion" data-accordion role="tablist">
                ...
                <li class="accordion-navigation">
                    ...
                    <br>
                        <p class="text-capitalize">Main topics students study:</p>
                        <ul class="circle">For a Core GCSE, pupils will complete the following:
                            <li>Biology – topics ranging from genes to evolution.</li>
                            <li>Chemistry – topics ranging from air quality to where chemicals come from.</li>
