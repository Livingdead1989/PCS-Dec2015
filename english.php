            ...
            <ul class="accordion" data-accordion role="tablist">
                ...
                <li class="accordion-navigation">
                    ...
                    <div id="panel1d" class="content" role="tabpanel" aria-labelledby="panel1d-heading">
                        ...
                        <p>These challenges allow pupils to apply the skills that they have learnt to real audiences and purposes. They are also a celebration of the learning.</p>
                        <br>
                        <p class="text-capitalize">Main skills students develop:</p>
                        <ul class="circle">
                            <li>Reading for pleasure and developing good reader strategies.</li>
                ...
                <li class="accordion-navigation">
                    <a href="#panel3d" role="tab" id="panel3d-heading" aria-controls="panel3d">Keystage 4 - GCSE - Language</a>
                ...
                <li class="accordion-navigation">
                    <a href="#panel4d" role="tab" id="panel4d-heading" aria-controls="panel4d">Keystage 4 - GCSE - Literature</a>
                    <div id="panel4d" class="content" role="tabpanel" aria-labelledby="panel4d-heading">
                        ...
                        <p class="text-capitalize">Main skills students develop:</p>
                        <ul class="circle">
                            <li>Using the PEE structure flexibly and with confidence to discuss a text and the writer’s intended effect.</li>
                            <li>Being able to select relevant, interesting and significant examples from the text to discuss.</li>
                            <li>Expertly using a range of reading strategies to study and enjoy a wide range of texts, from a variety of writers.</li>
                        </ul>
                        <small>For more information please visit the <a href="http://www.edexcel.com/" target="_blank">EdExcel website</a></small>
                    </div>
                </li>
