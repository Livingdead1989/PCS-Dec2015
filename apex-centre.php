...
<html class="no-js" lang="en" >
    <head>
        ...
        <title>Park Community School | Apex Centre</title>
...
<header class="header-misc">
    <div class="row">
        <div class="medium-8 large-8 columns">
            <h1>Apex Centre</h1>
            <p class="text-capitalize">Think It, Plan It, Build It</p>
        </div>
    </div>
</header>
...
<section>
    <div class="row">
        ...
        <div class="small-offset-2 small-pull-2 small-8 small-8 medium-pull-0 medium-offset-0 medium-5 columns"><img src="images/apex/apex-01.jpg" alt="Apex Centre - Trade Skills for Life"></div>
    </div>
    <br><br><br>
</section>
