...
<html class="no-js" lang="en" >
    <head>
        ...
        <title>Park Community School | Media</title>
...
<div class="row">
    <ul class="breadcrumbs" role="menubar" aria-label="breadcrumbs">
        ...
        <li role="menuitem" class="current"><a href="#">Media</a></li>
    </ul>
</div>
...
<section>
    <div class="row">
        ...
        <br>
            ...
            <h3>Aims</h3>
            <ul class="circle">
                <li>To analyse and respond to a range of media texts.</li>
                <li>To plan and present projects which show flair and creativity.</li>
                <li>To create pre-production work which uses appropriate forms and conventions.</li>
                <li>To be able to plan and research independently and effectively.</li>
            </ul>
            ...
            <ul class="accordion" data-accordion role="tablist">
                ...
                <li class="accordion-navigation">
                    <a href="#panel2d" role="tab" id="panel2d-heading" aria-controls="panel2d">Year 7-11 - BTEC</a>
