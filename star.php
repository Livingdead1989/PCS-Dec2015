...
<html class="no-js" lang="en" >
    <head>
        ...
        <title>Park Community School | STAR</title>
        ...
        <br>
            ...
            <p class="text-capitalize">Main topics students study:</p>
                        <ul class="circle">
                            ...
                            <li>Identity
                                <ul><em>Geography, Literacy, Values lead subjects</em>
                                    <li>
                            ...
                            <li>Enterprise
                                <ul><em>Numeracy, ICT and Literacy lead subjects</em>
                                    <li>
                        ...
                        <ul class="circle">
                            ...
                            <li><strong>Production</strong> - Plan, draft and edit a finished piece to a high standard for a range of audiences and purposes.</li>
                        </ul>
