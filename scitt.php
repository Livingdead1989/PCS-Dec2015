...
<header class="header-misc">
    <div class="row">
        <div class="medium-8 large-8 columns">
            <h1>SCITT</h1>
            <p class="text-capitalize">School Centred Initial Teacher Training</p>
        </div>
    </div>
</header>
...
<section class="grey-bg">
    ...
    <div class="row">
        <div class="medium-6 columns">
            <h4>Testimonials</h4>
            <blockquote>"Thank you to everyone at PCS. I have had a fantastic experience."
            <cite>English Trainee</cite></blockquote>
        ...
        <div class="medium-6 columns">
            ...
            <cite>Dance Trainee</cite></blockquote>

            <blockquote>"The professional themes programme was thorough and helped with the Qualified Teacher Standards as well as my professional development. I have had a brilliant time here at Park and will be sad to leave."
            <cite>English Trainee</cite></blockquote>
        </div>
    </div>
    <br><br>
