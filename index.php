...
<header id="homepage-hero">
    <div class="row">
        ...
        <div class="small-offset-2 small-8 small-pull-2 medium-offset-0 medium-5 medium-pull-0 large-4 columns">
            ...
            <img class="floating-logo" src="images/park-logo.svg" alt="Park Community School - Much More Than Just a School">
            <br class="show-for-small-only">
        </div>
    </div>
...
<section class="page-notification">
  <div class="row">
    <div class="large-12 columns">
        <p><a href="public-health.php" style="color:white;text-decoration:none;">We are aware that we have a number of students that are unwell at present because of a sickness bug. Please Click for more info.</a></p>
    </div>
  </div>
</section>
<!-- END NOTIFICATION -->
