...
<section>
    <div class="row">
        <div class="large-12 columns">
			...
			<p>Once in KS4 students then begin studying for the RSL Level 2 Certificate in Creative and Performing Arts (Acting) which consists of two units; Live Text and Live Performance.</p>
		<br><br>
        </div>
    </div>
</section>
